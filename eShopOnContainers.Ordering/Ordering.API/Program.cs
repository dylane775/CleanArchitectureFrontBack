...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        Title = "Ordering API",
        Version = "v1",
        Description = "Order Management Service for eShopOnContainers"
    });
...
app.MapGet("/health", async (OrderContext context) =>
{
    try
    {
...
Console.WriteLine("🚀 Ordering API démarrée avec succès !");
Console.WriteLine($"📍 Environnement : {builder.Environment.EnvironmentName}");
Console.WriteLine($"🔗 Swagger UI : http://localhost:5240/swagger");
